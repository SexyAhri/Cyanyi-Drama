...
| 视觉开发 | 美术指导、制作设计、角色概念、场景设计、道具服装、色彩脚本 | 视觉规范、风格板、色彩脚本、角色 Turnaround、场景与道具规格、参考资产谱系 | 主视觉语言统一；资产可追溯；角色比例、服装、场景时代与材质锁定 |
...
- 工作流必须支持 `draft -> review -> approved -> locked -> superseded`，审批门默认位于剧本锁定、视觉规范锁定、Animatic 锁定、镜头终审和母版交付。
...
| M8.2 剧本与美术部门 | 创作简报、剧本拆解、美术指导、视觉规范、色彩脚本、角色/场景/道具/服装规格 | 资产页可查看部门负责人、交付物、版本、来源、审批状态和阻塞原因 | 已完成 |
...
- 资产工作区新增“视觉规范、美术部门、角色、场景、道具、服装、色彩脚本”视图；VFX 工作区放在镜头与后期之间，并可从 Shot 直接打开 Breakdown。
...
| `feat(studio): add art department and visual development / 增加美术部门与视觉开发` | M8.2 美术指导、视觉规范、色彩脚本和资产规格工作区 | 已提交 |
