import { selectGlobalImage } from "@/lib/assets/global-store";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const candidateIndex =
      typeof body.candidateIndex === "number" ? body.candidateIndex : undefined;
    const image = await selectGlobalImage(
      user.id,
      kind,
