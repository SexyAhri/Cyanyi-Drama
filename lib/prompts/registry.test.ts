...
function expectedVersion(id: PromptId) {
  const versions: Record<PromptId, number> = {
    ...
    [PROMPT_IDS.STORY_SCREENPLAY_CONVERSION]: 12,
    [PROMPT_IDS.STORY_STORYBOARD_PLANNING]: 10,
    [PROMPT_IDS.STORY_CINEMATOGRAPHY]: 6,
    [PROMPT_IDS.STORY_ACTING_DIRECTION]: 7,
    [PROMPT_IDS.STORY_STORYBOARD_REFINEMENT]: 8,
    [PROMPT_IDS.STORY_VOICE_ANALYSIS]: 6,
    [PROMPT_IDS.STORY_CONTINUITY_REVIEW]: 4,
