...
本项目采用 [Cyanyi Drama 个人使用许可证 1.0](LICENSE)，属于源代码可用的
自定义许可证，不是 OSI 定义的开源许可证。

- 自然人可以将本项目用于学习、研究、评估和非商业个人开发。
- 公司内部使用、接单交付、收费服务、SaaS、广告、营收或其他商业用途，必须事先取得书面商业授权。
- 第三方依赖、资产和模型继续适用其各自的许可证。

商业授权请通过项目公开的联系渠道联系版权所有者。
